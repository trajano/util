...
<%
	...
	String securityPrincipal = request.getParameter("securityPrincipal");
	String securityCredentials = request.getParameter("securityCredentials");
	if (name == null) {
		name = "";
	}
...
<hr />
<form>
	JNDI Name: <input name="name" size="100" value="<%= name %>" /> <hr />
	<table>
	<tr>
	<td>
	Initial Context Factory:</td><td><input name="contextFactory" size="100" value="<%= contextFactory %>" /> </td></tr>
	<tr><td>Provider URL </td><td> <input name="providerUrl" size="100" value="<%= providerUrl %>" /> </td></tr>
	<tr><td>	Security Principal (Username) </td><td> <input name="securityPrincipal" size="100" value="<%= securityPrincipal %>" /> </td></tr>
	<tr><td>	Security Credentials (Password) </td><td> <input name="securityCredentials" size="100" value="<%= securityCredentials %>" /> </td></tr>
	</table>
	<input type="submit" />
</form>

<p><a href="jndi-web.jsp?name=java%3A<%=contextUrl%>">Browse java: tree</a></p>
